...
BASE = release_path("analysis")
PREDICTIONS = BASE / "secure_work" / "SOURCE_3710_LOCKED_LOCO_PREDICTIONS_SECURE.csv.gz"
RESULT_ROOT = BASE / "outputs/source3710_observation_sensitivity"
...
assert len(df) == 3710
assert int(df["PostopAKI"].sum()) == 152
...
# %%
restriction_rows = [metrics(df, "locked_LOCO_PI_restricted_rf", "all_3710")]
