...
|---|---|---|
| Exact sample sizes | Source cohort n=4014 with 155 events; public cohort flows and events are reported in Results, Figure 1 and Supplementary Information section 4. | Complete |
...
| Sample size | No prospective power calculation. Available retrospective cohorts were used; uncertainty and reference-event precision were quantified. A centre with one event and temporal validation with 37 events are reported as limitations. | Complete with limitation |
...
| Replication | Longitudinal stress tests used INSPIRE, MIMIC-IV and eICU; extensions transported empirical schedules and repeated the dual-target analysis for a haemoglobin-decline endpoint. | Complete |
...
| Code availability | Frozen code, tests and audits are public at GitHub release v1.1.0 under the MIT License; an independent archive DOI is still required. | Complete except archive DOI |
...
| Data provenance and versions | Five-centre source data; INSPIRE 1.4.2; MIMIC-IV 3.1; eICU 2.0. Methods. | Complete |
| Prediction landmark | End of surgery for the source and INSPIRE; ICU admission for MIMIC-IV and eICU. Methods. | Complete |
...
| Reproducibility | Fixed seeds, Jupytext `py:percent` code, input hashes, machine-readable audits, 46 figure-source sheets and synthetic tests. | Complete pending archive DOI |
...
| Participants and eligibility | Methods and Supplementary Information sections 2 and 4. Source denominator construction and consecutive enrolment still need author confirmation. | Submission blocker |
...
| Data sources and clusters | Five source centres and three public databases. Methods. | Complete |
...
| Open science | Aggregate Source Data and public release v1.1.0 are ready; independent archive DOI pending. | Submission blocker |

## PROBAST+AI self-audit

| Domain | Judgement | Reason |
|---|---|---|
| Participants | High concern for source clinical prediction claim | No untouched clinical external validation; source denominator and consecutive enrolment require confirmation; dense public cohorts are selected. |
...
| Data provenance and cohort construction | Methods, Figure 1 and Supplementary Information. | Complete with author-controlled source gaps |
...
| Reproducibility | Code, Source Data and audits prepared in GitHub release v1.1.0; archive DOI pending. | Submission blocker |
