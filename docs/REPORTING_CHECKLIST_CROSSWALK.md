...
| Code availability | Frozen code, tests and audits are released under the MIT License at GitHub tag v1.3.3. An archival DOI is optional for review and can be added if deposited. | Complete for review |
...
| Open science | Aggregate Source Data and tagged release v1.3.3 are prepared for review; an archive DOI is optional and can be added later. | Complete for review |
...
| Reproducibility | Code, Source Data and audits are prepared in GitHub tagged release v1.3.3; an archive DOI is optional for peer-review access. | Complete for review |
